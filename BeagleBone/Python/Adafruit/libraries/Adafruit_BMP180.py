...
class BMP180 :
  ...
  def readCalibrationData(self):
    ...
    self._cal_AC1 = self.readS16(self.__BMP180_CAL_AC1)   # INT16
    self._cal_AC2 = self.readS16(self.__BMP180_CAL_AC2)   # INT16
    self._cal_AC3 = self.readS16(self.__BMP180_CAL_AC3)   # INT16
    self._cal_AC4 = self.readU16(self.__BMP180_CAL_AC4)   # UINT16
    self._cal_AC5 = self.readU16(self.__BMP180_CAL_AC5)   # UINT16
    self._cal_AC6 = self.readU16(self.__BMP180_CAL_AC6)   # UINT16
    self._cal_B1 = self.readS16(self.__BMP180_CAL_B1)     # INT16
    self._cal_B2 = self.readS16(self.__BMP180_CAL_B2)     # INT16
    self._cal_MB = self.readS16(self.__BMP180_CAL_MB)     # INT16
    self._cal_MC = self.readS16(self.__BMP180_CAL_MC)     # INT16
    self._cal_MD = self.readS16(self.__BMP180_CAL_MD)     # INT16
  ...
  def readRawTemp(self):
    ...
    raw = self.readU16(self.__BMP180_TEMPDATA)
  ...
  def readPressure(self):
    ...
    if (self.debug):
      print "DBG: Pressure = %d Pa" % (pressure)
